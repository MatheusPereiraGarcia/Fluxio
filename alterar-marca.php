...
if (isset($_POST['salvar'])) {
    ...
    //3. Prepara a SQL
    $sql = "UPDATE marca SET nome = '$nome', obs = '$obs' WHERE id = '$id'";
    ...
    header('Location: listar-marca.php');
...
<body>
    ...
    <div class="container">
        ...
        <h1 class="mt-2">Alterar Marca</h1>
        <form method="post">
            ...
            <a type="button" href="listar-marca.php" class="botao-secundario">Voltar</a>
        </form>
    </div>
